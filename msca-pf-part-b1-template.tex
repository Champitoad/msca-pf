...
The project is structured into four technical work packages (\WP{1}-\WP{4}) to be completed over the 24-month fellowship. The work plan is designed to front-load the foundational theoretical work in the first year, allowing the second year to focus on extensions, applications, and dissemination.

\begin{description}
    \item[Deliverables] Each technical work package will culminate in a major scientific publication (\DE{1}-\DE{4}). An additional deliverable (\DE{5}) will be the creation of the project website/blog for public communication.
    \item[Milestones] Key milestones include the completion of the foundational theory (\MI{1}), the successful extension to intermediate and fixpoint logics (\MI{2}), and the development of the theory for dependent types (\MI{3}).
\end{description}

\paragraph{Risks and Mitigation}
Potential risks to the project have been identified and mitigation strategies are in place to ensure its successful completion. Regular meetings with the supervisor will allow for continuous risk assessment.
...
\begin{ganttchart}[
  ...
  \ganttgroup[group/.style={fill=green!30}]{Research Activities}{1}{24} \\
  \ganttbar[bar/.style={fill=blue!40}]{\WP{1}: Core Theory}{1}{7} \ganttmilestone[milestone/.style={fill=red!70}]{\MI{1}}{7} \\
  \ganttbar[bar/.style={fill=blue!50}]{\WP{2}: Intuitionistic/Classical Logic}{6}{12} \\
  \ganttbar[bar/.style={fill=blue!60}]{\WP{3}: Fixpoint Logic \& Recursion}{11}{18} \ganttmilestone[milestone/.style={fill=red!80}]{\MI{2}}{18} \\
  \ganttbar[bar/.style={fill=blue!70}]{\WP{4}: Dependent/Modal Logic}{16}{24} \ganttmilestone[milestone/.style={fill=red!90}]{\MI{3}}{24} \\
  \ganttgroup[group/.style={fill=orange!30}]{Dissemination \& Communication}{1}{24} \\
  \ganttbar{\DE{1}: Publication \WP{1}}{7}{8} \\
  \ganttbar{\DE{2}: Publication \WP{2}}{12}{13} \\
  \ganttbar{\DE{3}: Publication \WP{3}}{18}{19} \\
  \ganttbar{\DE{4}: Publication \WP{4}}{24}{24} \\
  \ganttbar{\DE{5}: Website/Blog}{1}{3} \\
  \ganttbar{Workshop Org.}{15}{23} \ganttmilestone{\MI{4}}{23} \\
\end{ganttchart}
