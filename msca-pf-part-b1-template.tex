...
%     bar/.style={fill=green!40, rounded corners},
...
%         minimum size=0.3cm
%     },
%     milestone label node/.style={anchor=north},
%     event/.style={
%         shape=circle,
%         fill=orange!80,
%         draw=orange,
...
%   % Work Packages
%   \ganttbar[bar/.style={fill=green!60}, name=wp1]{\WP{1}: Core Theory}{1}{7} \\
%   \ganttbar[bar/.style={fill=green!80}, name=wp2]{\WP{2}: Intuitionistic/Classical Logic}{6}{12} \\
%   \ganttbar[bar/.style={fill=red!60}, name=wp3]{\WP{3}: Fixpoint Logic \& Recursion}{11}{18} \\
%   \ganttbar[bar/.style={fill=blue!60}, name=wp4]{\WP{4}: Predicate/Modal/HO Logic}{17}{24} \\
%   % Milestones and Events
%   \ganttgroup{Milestones \& Events}{1}{24} \\
%   \ganttmilestone[name=m1]{\MI{1}}{7}
%   \ganttmilestone[name=m2]{\MI{2}}{18}
%   \ganttmilestone[name=m3]{\MI{3}}{24}
%   \ganttmilestone[
%     milestone node/.style={event},
%     name=workshop,
%   ]{Workshop (\MI{4})}{23} \\
%   % Dependencies
%   \ganttlink{wp1}{wp2}
